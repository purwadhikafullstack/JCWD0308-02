...
export class UserService {
  ...
  static updateUser = async (body: UpdateUserRequest, req: Request, res: Response) => {
    ...
    if (updatedUser.avatarUrl && getBaseUrl(API_URL) === getBaseUrl(currentUser?.avatarUrl!) && updatedUser.avatarUrl !== currentUser?.avatarUrl && currentUser?.avatarUrl !== `${API_URL}/public/images/avatar.png` ) {
