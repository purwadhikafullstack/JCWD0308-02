        ...
        <CardContent>
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-4">
              <InputField label="Name" name="displayName" value={formData.displayName || ''} onChange={handleChange} />
              ...
              <InputField label="Role" name="role" type="text" value={formData.role || ''} readOnly={true} className="bg-gray-100 cursor-not-allowed" onChange={() => {}} />
              <InputField label="Updated At" name="updatedAt" type="text" value={new Date(formData.updatedAt || new Date()).toLocaleDateString()} readOnly={true} className="bg-gray-100 cursor-not-allowed" onChange={() => {}} />
              {formData.role !== 'USER' && (
                <div>
