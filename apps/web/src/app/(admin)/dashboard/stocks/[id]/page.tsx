...
const StockDetail = () => {
  ...
  const handleUpdate = (
    updatedStock: Stock,
    updatedMutationsByMonth: Record<string, any[]>,
  ) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Button
        onClick={() => router.back()}
        className="mb-6 bg-gray-300 text-gray-800"
      >
        Back
      </Button>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <p>
          <strong>Store:</strong> {stock.store?.name}
        </p>
        <p>
          <strong>Total Stock:</strong> {stock.amount}
        </p>
        <p>
      ...
      {mutationsByMonth &&
        Object.entries(mutationsByMonth).map(([monthYear, mutations]) => (
          <div key={monthYear}>
                ...
                {mutations.map((mutation) => (
                  <TableRow key={mutation.id}>
                    <TableCell>
                      <span
                        className={
                          mutation.mutationType === 'STOCK_IN'
                            ? 'text-green-600'
                            : 'text-red-600'
                        }
                      >
        ...
        <Dialog open={isEditing} onOpenChange={setIsEditing}>
          ...
          <DialogContent>
            ...
            <EditStockForm
              ...
              products={[
                { id: stock.productId, title: stock.product?.title || '' },
              ]}
